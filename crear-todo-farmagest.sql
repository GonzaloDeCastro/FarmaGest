-- Script completo para crear la base de datos FarmaGest
-- Ejecutar con: psql -U postgres -f crear-todo-farmagest.sql
-- Si pide contraseña, simplemente presiona Enter (Enter en blanco)

-- ============================================
-- CREAR BASE DE DATOS
-- ============================================

-- Eliminar base de datos si existe (comentar si no quieres perder datos)
-- DROP DATABASE IF EXISTS farmagest;

-- Crear la base de datos (solo si no existe)
SELECT 'CREATE DATABASE farmagest'
WHERE NOT EXISTS (SELECT FROM pg_database WHERE datname = 'farmagest')\gexec

-- Conectar a la base de datos farmagest
\c farmagest
...
SELECT 
    ...
    'Sistema',
    'admin@farmagest.com',
    '$2b$10$rQZ8X8K8X8K8X8K8X8K8Xu8K8X8K8X8K8X8K8X8K8X8K8X8K8X8K',
